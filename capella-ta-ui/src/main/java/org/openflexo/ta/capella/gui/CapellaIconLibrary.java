...
package org.openflexo.ta.capella.gui;
...
public class CapellaIconLibrary {
	...
	public static final ImageIconResource CAPELLA_TA_BIG_ICON = new ImageIconResource(
			ResourceLocator.locateResource("Icons/capella-ta-32x32.png"));

	public static final ImageIconResource CAPELLA_TA_ICON = new ImageIconResource(
			ResourceLocator.locateResource("Icons/capella-ta-16x16.png"));
