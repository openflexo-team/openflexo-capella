...
package org.openflexo.technologyadapter.capella.model.fml;
...
public class CapellaFMLModelFactoryIntegrationTest extends AbstractModelFactoryIntegrationTestCase {

	private static final Logger logger = FlexoLogger.getLogger(CapellaFMLModelFactoryIntegrationTest.class.getPackage().getName());
